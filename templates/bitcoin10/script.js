...
jQuery(function ($) {
    ...
    if (scripts.length > 0) {
        ...
        path = src.substr(0, src.indexOf("script.js"/*tpa=http://obmen.tw1.ru/templates/bitcoin10/script.js*/));
    }
    ...
    header.css('background-image', "url('images/header.png'/*tpa=http://obmen.tw1.ru/templates/bitcoin10/images/header.png*/)".replace(/(url\(['"]?)/i, "$1" + path));
